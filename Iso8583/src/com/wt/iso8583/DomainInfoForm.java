...
public class DomainInfoForm {
	...
	static { // 初始化iso数组
		iso.add(new Iso8583Entity(8, EncodeType.BINARY, LengthType.FIX_LEN)); // 1
		iso.add(new Iso8583Entity(19, EncodeType.L_ASC, LengthType.LLVAR_LEN)); // 2
		iso.add(new Iso8583Entity(6, EncodeType.L_ASC, LengthType.FIX_LEN)); // 3
		iso.add(new Iso8583Entity(12, EncodeType.R_ASC, LengthType.FIX_LEN)); // 4
		iso.add(new Iso8583Entity(12, EncodeType.R_ASC, LengthType.FIX_LEN)); // 5
		iso.add(new Iso8583Entity(12, EncodeType.R_ASC, LengthType.FIX_LEN)); // 6
		...
		iso.add(new Iso8583Entity(8, EncodeType.L_ASC, LengthType.FIX_LEN));// 9
		iso.add(new Iso8583Entity(8, EncodeType.L_ASC, LengthType.FIX_LEN)); // 10
		iso.add(new Iso8583Entity(6, EncodeType.L_BCD, LengthType.FIX_LEN)); // 11
		iso.add(new Iso8583Entity(12, EncodeType.L_ASC, LengthType.FIX_LEN)); // 12
		iso.add(new Iso8583Entity(4, EncodeType.L_ASC, LengthType.FIX_LEN)); // 13
		iso.add(new Iso8583Entity(4, EncodeType.L_ASC, LengthType.FIX_LEN)); // 14
		...
		iso.add(new Iso8583Entity(3, EncodeType.L_ASC, LengthType.FIX_LEN)); // 23
		iso.add(new Iso8583Entity(3, EncodeType.L_ASC, LengthType.FIX_LEN)); // 24
		...
		iso.add(new Iso8583Entity(24, EncodeType.R_ASC, LengthType.FIX_LEN)); // 30
		iso.add(new Iso8583Entity(23, EncodeType.R_ASC, LengthType.LLVAR_LEN)); // 31
		iso.add(new Iso8583Entity(11, EncodeType.R_ASC, LengthType.LLVAR_LEN)); // 32
		iso.add(new Iso8583Entity(11, EncodeType.R_ASC, LengthType.LLVAR_LEN)); // 33
		...
		iso.add(new Iso8583Entity(12, EncodeType.R_ASC, LengthType.FIX_LEN)); // 37
		...
		iso.add(new Iso8583Entity(3, EncodeType.L_ASC, LengthType.FIX_LEN)); // 40
		iso.add(new Iso8583Entity(8, EncodeType.L_ASC, LengthType.FIX_LEN)); // 41
		iso.add(new Iso8583Entity(15, EncodeType.L_ASC, LengthType.FIX_LEN)); // 42
		iso.add(new Iso8583Entity(99, EncodeType.L_ASC, LengthType.LLVAR_LEN)); // 43
		...
		iso.add(new Iso8583Entity(999, EncodeType.L_ASC, LengthType.LLLVAR_LEN)); // 48
		iso.add(new Iso8583Entity(3, EncodeType.L_ASC, LengthType.FIX_LEN)); // 49
		iso.add(new Iso8583Entity(3, EncodeType.L_ASC, LengthType.FIX_LEN)); // 50
		iso.add(new Iso8583Entity(3, EncodeType.L_ASC, LengthType.FIX_LEN)); // 51
		...
		iso.add(new Iso8583Entity(20, EncodeType.R_ASC, LengthType.LLLVAR_LEN)); // 54
		iso.add(new Iso8583Entity(255, EncodeType.BINARY, LengthType.LLLVAR_LEN)); // 55
		...
		iso.add(new Iso8583Entity(999, EncodeType.L_ASC, LengthType.LLLVAR_LEN)); // 62
		iso.add(new Iso8583Entity(16, EncodeType.L_ASC, LengthType.LLLVAR_LEN)); // 63
		...
		iso.add(new Iso8583Entity(8, EncodeType.R_ASC, LengthType.FIX_LEN));//70
		iso.add(new Iso8583Entity(8, EncodeType.R_ASC, LengthType.FIX_LEN)); // 71
		iso.add(new Iso8583Entity(999, EncodeType.L_ASC, LengthType.LLLVAR_LEN)); // 72
		iso.add(new Iso8583Entity(6, EncodeType.L_ASC, LengthType.FIX_LEN)); // 73
		...
		iso.add(new Iso8583Entity(11, EncodeType.R_ASC, LengthType.LLVAR_LEN)); // 93
		iso.add(new Iso8583Entity(11, EncodeType.R_ASC, LengthType.LLVAR_LEN)); // 94
		iso.add(new Iso8583Entity(10, EncodeType.R_ASC, LengthType.LLVAR_LEN)); // 95
		...
		iso.add(new Iso8583Entity(12, EncodeType.R_ASC, LengthType.LLLVAR_LEN)); // 111
		...
		iso.add(new Iso8583Entity(999, EncodeType.L_ASC, LengthType.LLLVAR_LEN)); // 123
		iso.add(new Iso8583Entity(999, EncodeType.L_ASC, LengthType.LLLVAR_LEN)); // 124
		iso.add(new Iso8583Entity(999, EncodeType.L_ASC, LengthType.LLLVAR_LEN)); // 125
		iso.add(new Iso8583Entity(999, EncodeType.R_BCD, LengthType.LLVAR_LEN));//126
		iso.add(new Iso8583Entity(999, EncodeType.L_ASC, LengthType.LLLVAR_LEN)); // 127
		iso.add(new Iso8583Entity(8, EncodeType.R_BCD, LengthType.FIX_LEN));//128
	}
